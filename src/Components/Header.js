...
const Header = () => {
    ...
    return (
        <Navbar collapseOnSelect expand="md"
            ...
            sytle={{ width: '100%', position: 'fixed', zIndex: 100 }}
        >
            <Container>
                <Link to='/'>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ms-auto">
                        ...
                        >
                            <BiCart size="2rem" />
                            {!isEmpty && <span sytle={{position:'relative', left:'-21px', top:'-18px'}}>{totalItems}</span> }
                            {/* <span className='' style={{marginLeft: !isEmpty ? '-13px': 0}}>Cart</span> */}
                        </Link>
