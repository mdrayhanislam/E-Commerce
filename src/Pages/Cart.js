...
const Cart = () => {
    ...
    return (
        <Container className='py-4 mt-5'>
            <h1 className={`${theme ? 'text-light' : 'text-primary'} my-5 text-center`}>{isEmpty ? 'Your Cart is Empty' : 'The Cart'}</h1>
                ...
                </Table>
                {
                    ...
                    >
                        ...
                        <Col className='p-0' md={4}>
                            <Button variant='danger' className='m-2' onClick={()=> emptyCart()}><BsCartX size="1.7rem"/> Clear Cart</Button>
